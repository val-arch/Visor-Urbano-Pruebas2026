...
<body>
    <div class="acuse-box">
        ...
        <div class="row">
           ...
           <br>
           Carta Responsiva sobre documentos e información adjuntos en solicitud de Licencia de Funcionamiento con número de folio
           {{$data['result'][0]->folio}}  realizada en la plataforma de Visor Urbano Cuernavaca.
           </div>
           </div>
        </div><div class="row" style="padding-top:20px">
            <div class="col-12" >
                    <div style="font-size:14px; line-height: 1.5;" >En el municipio de {{$data['result'][0]->municipio}}, Morelos; siendo las _________ horas del día <i style="font-weight: 700;">{{date('d/m/Y')}}</i>,
                   la(el) suscrita(to) C. _________________________________, comparezco en mi calidad de solicitante de una licencia
                   de funcionamiento para ejercer la actividad comercial de <i style="font-weight: 700;">{{$data['result'][0]->nombre_scian}}</i> en el predio ubicado en
                  <i style="font-weight: 700;"> {{$data['domicilio']['calle']}} #{{$data['domicilio']['exterior']}} {{$data['domicilio']['interior']}} colonia {{$data['domicilio']['colonia']}} cp:{{$data['domicilio']['cp']}} </i> .
                  </div>

                   <br>
                   <div style="font-size:14px; line-height: 1.5;" >
                   Dicho lo anterior, con motivo de que no cuento con firma electrónica, comparezco ante esta autoridad con la finalidad de acreditar
                    mi identidad exhibiendo al efecto una identificación oficial consistente en __________________________ número ________________________,
                   ...
                   Siendo mi voluntad realizar y obtener el trámite ya señalado en líneas anteriores, manifiesto <b style="font-size:14px;font-weight: 700;">BAJO PROTESTA DE DECIR VERDAD,
                    ...
                    acredita plenamente mi identidad y la situación jurídica y técnica del predio donde se solicita la licencia de funcionamiento.
                   ...
                   Por último, solicito que todas las notificaciones, incluso las personales, se me realicen a través del medio electrónico denominado
                    Visor Urbano Cuernavaca al cual puedes acceder en la dirección de internet <a style="font-size:14px;font-weight: 700;" href="url">https://visorurbano.cuernavaca.gob.mx/</a>, y autorizo para que

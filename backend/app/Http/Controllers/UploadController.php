...
class UploadController extends Controller
{
  ...
  public function upload(Request $request, $name)
  {
    ...
    $role = Auth::user()->roles[0]->id;
      ...
      $this->historial($accion='Se subio la licencia de giro',$valor_anterior,$data2,$tipo=2,0);
       ...
       //  dd( count($request->file('file')) );
        if (is_array($request->file('file')) && count($request->file('file')) > 1) {
          ...
          foreach($request->file('file') as $file){
            ...
            $destinationPath = 'public/licencias_giro_file/' . $idConsulta;
          ...
          $data =  array(
            ...
            if ($respuesta === null) {
              ...
              DB::table('respuestas')->where('name', '=', $name)

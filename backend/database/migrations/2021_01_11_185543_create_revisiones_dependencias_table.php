...
class CreateRevisionesDependenciasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('revisiones_dependencias', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('resolucion_dependencias', function (Blueprint $table) {
            $table->id();
            $table->integer('id_tramite');
        ...
        Schema::create('solventacion', function (Blueprint $table) {
            $table->id();
            $table->integer('id_tramite');
            $table->integer('rol')->nullable();
            $table->integer('id_usuario')->nullable();
        ...
        Schema::create('chat_revisores', function (Blueprint $table) {
            $table->id();
            $table->integer('id_tramite');
    ...
    {
        Schema::dropIfExists('revisiones_dependencias');
        Schema::dropIfExists('resolucion_dependencias');
        Schema::dropIfExists('chat_revisores');
        Schema::dropIfExists('solventacion');
    }
}

  ...
  constructor(private http: HttpClient,
    ...
    licenciaPagada2(id,data){
      const httpOptions = {
        ...
        return this.http.post(environment.SERVER_ORIGIN +`generarLicenciaConstruccion/pagar/${id}`,data,httpOptions);
    }
    ...
    licenciaEscaneada2(id,data){
      const httpOptions = {
        ...
        return this.http.post(environment.SERVER_ORIGIN +`generarLicenciaConstruccion/pdf_firmado/${id}`,data,httpOptions);
    }

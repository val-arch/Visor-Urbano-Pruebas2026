...
import { navigationConstruccionUser } from 'app/navigation/navigationConstruccionUsers';
...
//Nav Construccion
import { navigationAdminConstruccion } from 'app/navigation/navigationAdminConstruccion';
import { navigationConstruccion } from 'app/navigation/navigationConstruccion';
import { navigationRevisorConstruccion } from 'app/navigation/navigationRevisorConstruccion';
...
export class AppComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        if (userInfo.type_user == 1) {
            if (userInfo.permiso_dir == 1) {
                
                this._fuseNavigationService.register('user-nav-ce', navigationConstruccionUser);
                this._fuseNavigationService.setCurrentNavigation('user-nav-ce');
            } else {
                switch (this._token.get<any>().role) {
                    case 0:
                    case 1:
                        this._fuseNavigationService.register('user-nav-c', navigationUser);
                        this._fuseNavigationService.setCurrentNavigation('user-nav-c');

                        break;
                    case 2:

                        this._fuseNavigationService.register('ventanilla-nav-c', navigationVentanilla);
                        this._fuseNavigationService.setCurrentNavigation('ventanilla-nav-c');

                        break;
                    case 3:

                        this._fuseNavigationService.register('revisor-nav-c', navigationRevisor);
                        this._fuseNavigationService.setCurrentNavigation('revisor-nav-c');

                        break;
                    case 4:
                        this._fuseNavigationService.register('director-nav-c', navigationConstruccion);
                        this._fuseNavigationService.setCurrentNavigation('director-nav-c');
                        break;
                    case 5:
                        this._fuseNavigationService.register('admin-nav-C', navigationAdminConstruccion);
                        this._fuseNavigationService.setCurrentNavigation('admin-nav-c');

                        break;
                    case 6:
                        this._fuseNavigationService.register('tec-nav-c', navigationTec);
                        this._fuseNavigationService.setCurrentNavigation('tec-nav-c');

                        break;
                    default:
                        this._fuseNavigationService.register('revisor-nav-c', navigationRevisorConstruccion);
                        this._fuseNavigationService.setCurrentNavigation('revisor-nav-c');
                        break;
                }
            }

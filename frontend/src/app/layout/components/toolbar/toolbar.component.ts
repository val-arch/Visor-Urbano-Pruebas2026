...
import { DialogCambiarContrasenaComponent} from 'app/routes/auth/dialog-cambiar-contrasena/dialog-cambiar-contrasena.component';
...
export class ToolbarComponent implements OnInit, OnDestroy
{
    ...
    cerrar(){
        ...
        setTimeout(() => window.location.href = `/ingresar`,1000);
    }

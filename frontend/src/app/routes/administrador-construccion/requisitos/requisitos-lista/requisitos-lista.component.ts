...
@Component({
  selector: "app-requisitos-lista",
  templateUrl: "./requisitos-lista.component.html",
  styleUrls: ["./requisitos-lista.component.scss"],

})
export class RequisitosListaComponent implements OnInit {

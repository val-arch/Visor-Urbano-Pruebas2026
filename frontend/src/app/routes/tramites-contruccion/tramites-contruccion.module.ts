...
import { ResumenTramiteComponent } from '../ingresar-tramite-construccion/tramite/shared/resumen-tramite/resumen-tramite.component';
...
import { DialogResolutivoComponent } from './list/dialog-resolutivo/dialog-resolutivo.component';
...
@NgModule({
  declarations: [TramitesComponent, DetalleComponent, ListComponent, EmitirLicenciaComponent, ResumenComponent, RevisionComponent, OrdenPagoComponent, DialogResolutivoComponent],
  imports: [
    CommonModule,
    TranslateModule,
    FuseSharedModule,
...
export class TramitesContruccionModule { }

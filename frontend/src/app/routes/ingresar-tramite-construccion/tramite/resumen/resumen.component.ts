...
export class ResumenComponent implements OnInit {
    ...
    carta() {
        window.open(
            `${environment.SERVER_ORIGIN}cartaResponsivaConstruccion/${btoa(this.folio)}`,
            "_blank"
        );
    }
    cartaUpload() {
    ...
    subirCarta(event) {
        ...
        this._resumenService.uploadCartaConstruccion(formData, this.folio).subscribe(
            (r: any) => {
                console.log(r);
    ...
    noTengoFirma() {
        this._resumenService.noFirmaElectronicaConstruccion(this.folio).subscribe(
            (r: any) => {
                console.log(r);
                let acuse = "Continuar";
    ...
    continuar() {
        this._resumenService.tramiteConstruccionContinuar(this.folio).subscribe(
            (r: any) => {
                console.log(r);
                let text,
                    apertura = "",
        ...
        ${
            apertura != ""
                ...
                : ""
                    ...
                    }${r.data.acuse_firma_electronica_url}">AQUÍ.</a></div>`;
                    window.open(

...
statusOptions = [
  ...
  { value: 'Adeudo', viewValue: 'Adeudo' },
  { value: 'Vigente', viewValue: 'Vigente' },
  { value: 'Cancelada', viewValue: 'Cancelada' },
  { value: 'Suspendida', viewValue: 'Suspendida' },
  { value: 'Baja', viewValue: 'Baja' },
  { value: 'Sanción', viewValue: 'Sanción' },
  { value: 'Renovar', viewValue: 'Renovar' } ,
];
...
constructor(
  ...
  applyFilter() {
      ...
      this.getDataFilter(this.selectedStatus);
  ...
  getDataFilter(filter) {
    this.isLoading = true;
    this._historicoLicencia
      .getLicenciasEmitidas(this.page, filter)
      .subscribe(
        (res: any) => {
          const repeditos3 = res.data["data"];
          this.total = res.data.total;

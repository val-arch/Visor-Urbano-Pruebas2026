...
export class TramiteEditComponent implements OnInit {
  ...
  generateFilterForm(step): FormGroup {
    ...
    if (step == 4) {
      ...
      baseForm.addControl('hora_a', new FormControl());
      baseForm.addControl('hora_c', new FormControl());
      baseForm.addControl('superficie', new FormControl());
    } else {
  ...
  getCamposDinamicos() {
    this._campoDinamico.getCamposDinamicosId().subscribe(
      (res: any) => {
        this.camposFijos = res[1][0].data;
        this.camposDinamicos = res[0].data.concat(this.camposFijos);
        this.camposDinamicos2 = res[2][0].data[0];
        this.filterForm_step4.controls['hora_a'].setValue(this.camposDinamicos2['hora_a']);
        this.filterForm_step4.controls['hora_c'].setValue(this.camposDinamicos2['hora_c']);
        this.filterForm_step4.controls['superficie'].setValue(this.camposDinamicos2['superficie_autorizada']);
  ...
  updateHorasSuperficie(){
    this._campoDinamico.updateHorasSuperficie(this.filterForm_step4.controls['hora_a'].value, this.filterForm_step4.controls['hora_c'].value, this.filterForm_step4.controls['superficie'].value, this.folio).subscribe((res: any) => {

...
@Component({
  selector: 'visor-resumen-revision',
  templateUrl: './resumen-tramite-revision.component.html',
  styleUrls: ['./resumen-tramite-revision.component.scss','../../ingresar-tramite/formulario-vu.scss'],
  animations:fuseAnimations
})
export class ResumenTramiteRevisionComponent implements OnInit {
  campos_dinamicos: [];
  @Input() folio :string ;
